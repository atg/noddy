...
NSString* node_string_to_cocoa(v8::Local<v8::String> str);
NSNumber* node_number_to_cocoa(v8::Local<v8::Number> num);
NSArray* node_array_to_cocoa(v8::Local<v8::Array> arr);
NSDictionary* node_object_to_cocoa(v8::Local<v8::Object> obj);
id node_to_cocoa(v8::Local<v8::Value> val);
